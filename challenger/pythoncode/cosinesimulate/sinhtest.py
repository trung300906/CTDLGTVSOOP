...
if __name__ == "__main__":
    ...
    num_products = 3# Thay đổi giá trị này theo nhu cầu của bạn
    # Số lượng đặc trưng mỗi sản phẩm (cột)
    num_features = 3# Thay đổi giá trị này theo nhu cầu của bạn
    # Tên file đầu ra
    output_file = "/run/media/trunglinux/linuxandwindows/code/CTDLGTVSOOP/challenger/pythoncode/cosinesimulate/input.txt"
    #output_file = "D:\\code\\CTDLGTVSOOP\\challenger\\pythoncode\\cosinesimulate\\input.txt"

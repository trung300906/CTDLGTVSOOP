...
def compute_cosine_matrix(features, num_workers):
    ...
    sizeof = sys.getsizeof(return_dict)  
...
#     features = [[3, 4, 1], [2, 4, 5], [4, 4, 2], [4, 5, 6]]
    ...
    cosine_matrix , sizeof= compute_cosine_matrix(features, num_worker)
    end = time()
    return cosine_matrix, end - start, sizeof

if __name__ == "__main__":
    output, time_run , sizeof= main("/run/media/trunglinux/linuxandwindows/code/CTDLGTVSOOP/challenger/pythoncode/cosinesimulate/input.txt")
    # Print results to console (if needed)
    #print(output)
    print(time_run)
    print(sizeof/1024 , "MB")